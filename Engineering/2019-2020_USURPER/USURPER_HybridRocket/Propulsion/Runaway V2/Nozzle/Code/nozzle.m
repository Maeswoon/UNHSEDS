...
%   Problem parameters
T_c = 700;     % Temperature in the combustion chamber (K)
P_c = 2.068e+6;    % Pressure in the combustion chamber (Pa)
P_amb = 101e3;  % Ambient pressure (Pa)
T_amb = 300;    % Ambient temperature (K)
Cp = 50.5/.046;  Cv = Cp-188.91;
gamma = Cp/Cv;   % Ratio of Specific Heats Cp/Cv (Gamma)
W = 44;         % Molecular weight of gas (kg/kmol)
width = .75*.0254;% Nozzle width (meters)
h_th = .75*.0254; % Throat  height (meters)
