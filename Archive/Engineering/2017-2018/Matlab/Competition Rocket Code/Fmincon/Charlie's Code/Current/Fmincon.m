...
x16b = [0,5];     %Cruise Time between Sustainer and Booster Stages

lb = [x1b(1),x2b(1),x3b(1),x4b(1),x5b(1),x6b(1),x7b(1),x8b(1),x9b(1),x10b(1),x11b(1),x12b(1),x13b(1),x14b(1),x15b(1),x16b(1)];
ub = [x1b(2),x2b(2),x3b(2),x4b(2),x5b(2),x6b(2),x7b(2),x8b(2),x9b(2),x10b(2),x11b(2),x12b(2),x13b(2),x14b(2),x15b(2),x16b(2)];
