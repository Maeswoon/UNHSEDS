...
Daftfins         = Dstagingcoupler + LcouplerBodyTube/2 + Lboosterbodytube - Laftfins/2;  % Not exact Centroid
...
xmainparachute      = 0.12;    % From aft of E-Bay
xboosterparachute   = 0.12;    % From aft of Coupler
...
DSEDSaltimeter = xSEDSaltimeter + LSEDSaltimeter;
Dswitches      = Lnosecone + xswitch + Lswitch/2;

% Recovery Components:
Ddrogueparachute    = xdrogueparachute + Ldrogueparachute;
Dmainparachute      = Lnosecone + Lebay + xmainparachute + Lmainparachute/2;
Dboosterparachute   = Dstagingcoupler + Lstagingcoupler + xboosterparachute + Lboosterparachute/2 ;   

% Engine Retainment:
Dcenteringring1      = Dsustbodytube + Lsustbodytube + xcenteringring1;
Dcenteringring2      = Dsustbodytube + Lsustbodytube + xcenteringring2;
Dcenteringring3      = Dboosterbodytube + Lsustbodytube + xcenteringring3;
Dcenteringring4      = Dboosterbodytube + Lsustbodytube + xcenteringring4;
